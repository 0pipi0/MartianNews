package com.martian.daogenerator;
...
public class DaoGenerator {
    public static void main(String[] args) throws Exception {
        int version = 1;
        String defaultJavaPackage = "com.martian.martiannews.greendao";
...
//      schema.setDefaultJavaPackageDao("me.itangqi.dao");
        ...
        new de.greenrobot.daogenerator.DaoGenerator().generateAll(schema, "./app/src/main/java-gen");
    }
