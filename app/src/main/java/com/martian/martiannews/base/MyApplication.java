...
import com.martian.martiannews.mvp.ui.activitys.AboutActivity;
import com.martian.martiannews.mvp.ui.activitys.MainActivity;
import com.martian.martiannews.push.PushUtil;
...
public class MyApplication extends Application {
  ...
  private void initMiPush() {
    if (shouldInit()) {
      MiPushClient.registerPush(this, PushUtil.PUSH_MI_APP_ID, PushUtil.PUSH_MI_APP_KEY);
    }
  }
  ...
  public static class DemoHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
      ...
      final Intent intent2 = new Intent(context, AboutActivity.class);
